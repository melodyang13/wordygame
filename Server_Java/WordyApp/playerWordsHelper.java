...
/**
* WordyApp/playerWordsHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from Wordy.idl
* Wednesday, May 17, 2023 4:04:53 PM SGT
*/

abstract public class playerWordsHelper
{
  private static String  _id = "IDL:WordyApp/playerWords:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (playerWordsHelper.id (), "playerWords", __typeCode);
    }
    return __typeCode;
  }
